...
_INPUT = flags.DEFINE_string("input", "kitchen.xml", "the input scene to populate")
_OUTPUT = flags.DEFINE_string("input", "kitchen.xml", "filename to save the populated scene")

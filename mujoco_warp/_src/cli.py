...
ISLANDS_EXPERIMENTAL_OVERRIDE = flags.DEFINE_bool(
  "islands_experimental_override",
  False,
  "Enable islands even if disabled by disableflags",
)
...
def init_structs(
  ...
  types.ISLANDS_EXPERIMENTAL_OVERRIDE = ISLANDS_EXPERIMENTAL_OVERRIDE.value

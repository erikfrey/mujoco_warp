...
def put_model(mjm: mujoco.MjModel) -> types.Model:
  ...
  # override by setting ISLANDS_EXPERIMENTAL_OVERRIDE = True
  # TODO(team): remove after improving island solver performance
  opt.disableflags |= int(types.DisableBit.ISLAND)
...
def make_data(
  ...
  island_enabled = types.ISLANDS_EXPERIMENTAL_OVERRIDE or not (mjm.opt.disableflags & int(types.DisableBit.ISLAND))
